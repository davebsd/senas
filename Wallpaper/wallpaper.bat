@echo off
curl -o "%temp%\rsimage.jpg" "https://raw.githubusercontent.com/davebsd/senas/refs/heads/main/Wallpaper/rsimage.jpg" > nul 2>&1

reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Policies\ActiveDesktop" /v NoChangingWallPaper /f > nul 2>&1
gpupdate /force > nul 2>&1

powershell -ExecutionPolicy Bypass -Command "Set-ItemProperty -Path 'HKCU:\Control Panel\Desktop' -Name Wallpaper -Value '%temp%\rsimage.jpg'" > nul 2>&1
...
del /q /s "%temp%\wallpaper.bat" && exit > nul 2>&1
