...
'Setup Location se mantem em branco
...
SetupOptions = "/acceptlicense /server='http://glpisenaiba.fieb.org.br/glpi/plugins/fusioninventory' /delaytime=3600 /httpd-port='62354' /httpd-trust='127.0.0.1/32' /execmode=service /installtasks=default /no-start-menu /runnow /S"
' adicionado o Server referente ao link utilizado no dendezeiros
' Setup
...
'
Force = "Yes"  'Editado para sim caso alguma maquina ja possua o programa
